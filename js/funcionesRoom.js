...
function postRoom(){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://150.230.27.233:8080/api/Room/save",
        type:"POST",
        datatype:"JSON",
...
function putRoom(idBotonActualizar){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://150.230.27.233:8080/api/Room/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteRoom(idBotonBorrar){
        ...
        $.ajax({
            url:"http://150.230.27.233:8080/api/Room/"+idBotonBorrar,
            type:"DELETE",
            datatype:"JSON",
            contentType:"application/JSON",
            data:JSON.stringify(myData),
            success:function(respuesta){
                alert("se borro correctamente la habitación");
                window.location.reload();
            }
        });
...
function getRoom_Category(){
    $.ajax({
        url:"http://150.230.27.233/api/Category/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
